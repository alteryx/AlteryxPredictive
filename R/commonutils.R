...
# components of the summary report as well as the model's coefficients in a JSON
...
# function returns a data frame that is a set of key-value pairs for the
# components of the summary report as well as the model's coefficients in a JSON
# formatted character string. The coefficient JSON string is really for future
# option value
...
#########
# The function Alteryx.ReportAnova creates a data frame of key-value pairs
# for the purpose of assisting Alteryx's reporting tools to report the
# results of a type II ANOVA for a LM or GLM model object. The last key-
# value indicates whether the report is for a lm or glm model which is
# relevant for labeling columns in the output created by Alteryx.
...
Alteryx.ReportAnova <- function (model.obj)
{
    ...
    the.anova <- Anova(model.obj, type = "II")
